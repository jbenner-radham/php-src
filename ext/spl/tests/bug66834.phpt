...
var_dump($object->offsetExists('foo'), is_set($object['foo']), empty($object['foo']));
var_dump($object->offsetExists('bar'), is_set($object['bar']), empty($object['bar']));
var_dump($object->offsetexists('baz'), is_set($object['baz']), empty($object['baz']));
var_dump($object->offsetexists('qux'), is_set($object['qux']), empty($object['qux']));
...
$object['foo'] = 42;
var_dump($object->offsetExists('foo'), $object->offsetExists('sbb'), is_set($object['foo']), is_set($object['sbb']), empty($object['sbb']));
