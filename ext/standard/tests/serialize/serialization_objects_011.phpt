...
Class A {
	...
	function audit() {
		return is_set($this->APriv, $this->AProt, $this->APub);
	}
}
...
Class B extends A {
	...
	function audit() {
		return  parent::audit() && is_set($this->AProt, $this->APub,
...
Class C extends B {
	...
	function audit() {
		return parent::audit() && is_set($this->APriv, $this->AProt, $this->APub,
