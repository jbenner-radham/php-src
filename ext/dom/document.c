...
static void dom_parse_document(INTERNAL_FUNCTION_PARAMETERS, int mode) {
	...
	id = getThis();
	if (id != NULL && ! instance_of_function(Z_OBJCE_P(id), dom_document_class_entry TSRMLS_CC)) {
		id = NULL;
	}
...
PHP_METHOD(domdocument, registerNodeClass)
{
	...
	if (basece == NULL || ! instance_of_function(basece, dom_node_class_entry TSRMLS_CC)) {
	...
	if (ce == NULL || instance_of_function(ce, basece TSRMLS_CC)) {
