...
void tokenizer_register_constants(INIT_FUNC_ARGS) {
	...
	REGISTER_LONG_CONSTANT("T_INSTANCE_OF", T_INSTANCE_OF, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("T_IS_SET", T_IS_SET, CONST_CS | CONST_PERSISTENT);
...
char *get_token_type_name(int token_type)
{
	switch (token_type) {
		...
		case T_INSTANCE_OF: return "T_INSTANCE_OF";
