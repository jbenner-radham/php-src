--TEST--
Ensure fix to bug45622 doesn't cause __is_set() to be called when ArrayObject::ARRAY_AS_PROPS is used.
--FILE--
<?php
class UsesMagic extends ArrayObject {
	function __get($n)     {  echo "In " . __METHOD__ . "!\n"; }
	function __set($n, $v) {  echo "In " . __METHOD__ . "!\n"; }
	function __is_set($n)   {  echo "In " . __METHOD__ . "!\n"; }
...
echo "Shouldn't trigger __is_set.\n";
is_set($ao->prop4);
?>
--EXPECTF--
